...
import { SearchIcon, EditIcon, TrashIcon, GiftIcon } from '../../components/ui/Icons';
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                <h1 className="text-3xl font-bold text-ift-dark-blue">{t('page_title_admin_manage_coupons')}</h1>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left text-gray-500">
                        <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                <th scope="col" className="px-6 py-3">{t('admin_coupons_code')}</th>
                                <th scope="col" className="px-6 py-3">{t('admin_coupons_discount')}</th>
                        ...
                        <tbody>
                            {MOCK_AFFILIATE_COUPONS.map((coupon) => (
